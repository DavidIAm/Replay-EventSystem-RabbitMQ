...
TODO: document the way of making rabbitmq make more verbose informations

=head1 CONFIGURATION AND ENVIRONMENT

This is automatic, the messages are merely encapsulated for transportk
...
Nothing additional to that which is inherent in Replay messaging
